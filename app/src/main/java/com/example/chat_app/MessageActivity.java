...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar tool = findViewById(R.id.TBar);
        tool.setTitle("");
        setActionBar(tool);


        tool.setNavigationOnClickListener(v -> startActivity(new Intent(MessageActivity.this, MainPageActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP)));
